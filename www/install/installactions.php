...
function installNewDatabase($AIGAION2_DB_HOST, $AIGAION2_DB_USER, $AIGAION2_DB_PWD, $AIGAION2_DB_NAME, $AIGAION2_DB_PREFIX)
{
	global $theDatabase;
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."aigaiongeneral` (  `version` varchar(10) NOT NULL default '',  `releaseversion` varchar(10) NOT NULL,  PRIMARY KEY  (`version`)) ENGINE=InnoDB CHARACTER SET utf8;");
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."changehistory` (  `version` varchar(20) NOT NULL,  `type` varchar(50) NOT NULL,  `description` text NOT NULL,  PRIMARY KEY  (`version`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("INSERT INTO  `".$AIGAION2_DB_PREFIX."changehistory` (`version`,`type`,`description`) 
			...
			');");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."config` (  `setting` varchar(255) NOT NULL,  `value` mediumtext NOT NULL,  PRIMARY KEY  (`setting`)) ENGINE=InnoDB CHARACTER SET utf8;");
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."grouprightsprofilelink` (  `group_id` int(10) NOT NULL,  `rightsprofile_id` int(10) NOT NULL,  PRIMARY KEY  (`group_id`,`rightsprofile_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."rightsprofiles` (  `rightsprofile_id` int(10) NOT NULL auto_increment,  `name` varchar(20) NOT NULL,  PRIMARY KEY  (`rightsprofile_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("INSERT INTO  `".$AIGAION2_DB_PREFIX."rightsprofiles` (`rightsprofile_id`,`name`) 
                     VALUES  (1,'admin_rights'), 
                             (2,'editor_rights'), 
                             (3,'reader_rights'), 
                             (4,'guest_rights');");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."topicpublicationlink` (  `topic_id` int(10) unsigned NOT NULL default '0',  `pub_id` int(10) unsigned NOT NULL default '0',  PRIMARY KEY  (`topic_id`,`pub_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."topics` (  `topic_id` int(10) NOT NULL auto_increment,  `name` varchar(50) default NULL,  `cleanname` VARCHAR(50) NOT NULL default '', `description` mediumtext,  `url` varchar(255) NOT NULL default '',  `user_id` int(10) unsigned NOT NULL default '0',  `read_access_level` enum('private','public','intern','group') NOT NULL default 'intern',  `edit_access_level` enum('private','public','intern','group') NOT NULL default 'intern',  `group_id` int(10) unsigned NOT NULL default '0',  `derived_read_access_level` enum('private','public','intern','group') NOT NULL default 'intern',  `derived_edit_access_level` enum('private','public','intern','group') NOT NULL default 'intern',  PRIMARY KEY  (`topic_id`),  KEY `name` (`name`)) ENGINE=InnoDB CHARACTER SET utf8;");
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."topictopiclink` (  `source_topic_id` int(10) NOT NULL default '0',  `target_topic_id` int(10) NOT NULL default '0',  PRIMARY KEY  (`source_topic_id`),  KEY `target_topic_id` (`target_topic_id`)) ENGINE=InnoDB CHARACTER SET utf8 COMMENT='Hierarchy of topics; typed relations';");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."userbookmarklists` (  `user_id` int(10) NOT NULL,  `pub_id` int(10) NOT NULL,  PRIMARY KEY  (`user_id`,`pub_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."usergrouplink` (  `user_id` int(10) NOT NULL,  `group_id` int(10) NOT NULL,  PRIMARY KEY  (`user_id`,`group_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."userpublicationmark` (  
                ...
                PRIMARY KEY  (`pub_id`,`user_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."userrights` (  `user_id` int(10) NOT NULL,  `right_name` varchar(20) NOT NULL,  PRIMARY KEY  (`right_name`,`user_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
        ...
        _query("CREATE TABLE `".$AIGAION2_DB_PREFIX."usertopiclink` (  `collapsed` int(2) NOT NULL default '0',  `user_id` int(10) NOT NULL default '0',  `topic_id` int(10) NOT NULL default '0',  `star` int(2) NOT NULL default '0',  PRIMARY KEY  (`user_id`,`topic_id`),  KEY `topic_id` (`topic_id`)) ENGINE=InnoDB CHARACTER SET utf8;");
